...
The package version source of truth is `[project].version` in `pyproject.toml` (currently `0.1.0`). The `version` field in the runtime configuration is preserved as configuration-document data and is not a package-release version. The `0.1.1`–`0.1.9` sections below are historical development milestones: no corresponding Git tag or GitHub Release exists.
...
## Historical milestone 0.1.9 — 2026-05-11
...
## Historical milestone 0.1.8 — 2025-11-08
...
## Historical milestone 0.1.7 — 2025-11-08
...
## Historical milestone 0.1.6 — 2025-11-08
...
## Historical milestone 0.1.2 — 2025-11-07
...
## Historical milestone 0.1.3 — 2025-11-07
...
## Historical milestone 0.1.1 — 2025-11-07
